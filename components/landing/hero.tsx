  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="rounded-[2rem] border border-white/10 bg-white/6 p-8 shadow-[0_40px_120px_rgba(0,0,0,0.55)] backdrop-blur-2xl sm:p-10">
          <div className="rounded-[1.6rem] border border-white/10 bg-[#0d0d0d]/90 p-6">
